...
var htmx = (function () {
	...
	const R = de
		.map(function (e) { return "[hx-" + e + "], [data-hx-" + e + "]"; })
		.join(", ");
	function d(e) {
	...
	function a(e, t)  { return ee(e, t) || ee(e, "data-" + t); }
	...
	function te()    { return document; }
	function y(e, t) { return e.getRootNode ? e.getRootNode({ composed: t }) : te(); }
	...
	function ne(t, n) {
		...
		q(t, function (e)  { return !!(r = o(t, ce(e), n)); });

		if (r !== "unset") { return r; }
	}

	function h(e, t) { return e instanceof Element && e.matches(t); }
	...
	function L(e) {
		if ("parseHTMLUnsafe" in Document) { return Document.parseHTMLUnsafe(e); }

		const t = new DOMParser();
		return t.parseFromString(e, "text/html");
	}

	function N(e, t) { while (t.childNodes.length > 0) { e.append(t.childNodes[0]); } }
	...
	function ie(t, n) { if (t) { for (let e = 0; e < t.length; e++) { n(t[e]); } } }
	...
	function se(e)    { return e.getRootNode({ composed: true }) === document; }
	...
	function U(e) {
		...
		if (t)        { e = t.pathname + t.search; }
		if (e != "/") { e = e.replace(/\/+$/, ""); }
		return e;
	}
	function e(e) { return On(te().body, function () {return eval(e); }); }
	function V(t) {
		const e = Q.on("htmx:load", function (e) { t(e.detail.elt); });
		return e;
	}
	function j() {
	...
	function _(e, t) {
		e = w(e);
		if (t) { b().setTimeout(function () { _(e); e = null; }, t); }
		else   { u(e).removeChild(e); }
	}
	function ce(e) { return e instanceof Element     ? e : null; }
	function z(e)  { return e instanceof HTMLElement ? e : null; }
	function J(e)  { return typeof e === "string"    ? e : null; }
	function p(e)  { return (e instanceof Element || e instanceof Document || e instanceof DocumentFragment) ? e : null; }
	
	function K(e, t, n) {
		e = ce(w(e));
		if (!e) { return; }
		if (n)  { b().setTimeout(function () { K(e, t); e = null; }, n); }
	...
	function G(e, t, n) {
		...
		if (n) { b().setTimeout(function () { G(r, t); r = null; }, n); } 
		else   {
			if (r.classList) {
	...
	function W(e, t) { e = w(e); e.classList.toggle(t); }
	function Z(e, t) {
		e = w(e);
		ie(e.parentElement.children, function (e) { G(e, t); });
		K(ce(e), t);
	}
	function g(e, t) {
		e = ce(w(e));
		if (e) { return e.closest(t); }
		return null;
	}
	...
	function m(t, r, n) {
		if (r.indexOf("global ") === 0) { return m(t, r.slice(7), true); }
		...
		while (o.length > 0) {
			const r = pe(o.shift());
			let e;
			if      (r.indexOf("closest ") === 0) { e = g(ce(t), pe(r.slice(8))); } 
			else if (r.indexOf("find ")    === 0) { e = f(p(t),  pe(r.slice(5))); }
			
			else if (r === "next"     || r === "nextElementSibling")     { e = ce(t).nextElementSibling; } 
			else if (r.indexOf("next ")    === 0)                        { e = ge(t, pe(r.slice(5)), !!n); }
			else if (r === "previous" || r === "previousElementSibling") { e = ce(t).previousElementSibling; }

			else if (r.indexOf("previous ") === 0) { e = me(t, pe(r.slice(9)), !!n); } 
			else if (r === "document")             { e = document; } 
			else if (r === "window")               { e = window;   }
			else if (r === "body")                 { e = document.body; } 
			else if (r === "root")                 { e = y(t, !!n); }
	...
	function ue(e, t) {
		if (typeof e !== "string") { return m(e, t)[0];         }
		else                       { return m(te().body, e)[0]; }
	}
	function w(e, t) {
		if (typeof e === "string") { return f(p(t) || document, e); }
		else                       { return e; }
	}
	function ye(e, t, n, r) {
		if (P(t)) { return { target: te().body, event: J(e), listener: t, options: n }; } 
		else      { return { target: w(e),      event: J(t), listener: n, options: r }; }
	}
	function xe(t, n, r, o) {
		Gn(function () {
			const e = ye(t, n, r, o);
	...
	function we(t, n) {
		...
		if (e) {
			if (e === "this") {
				...
				if (o) {
					const i = ce( q(t, function (e) { return e !== t && s(ce(e), n); }), );
					if (i) { r.push(...we(i, n)); }
				}
				if (r.length === 0) {
	...
	function Se(e, t) { return ce( q(e, function (e) { return a(ce(e), t) != null; }) ); }
	...
	function Ee(e) {
		...
		if (t) {
			...
			const n = oe(e);
			if (n.boosted) { return te().body; } 
			else           { return e;         }
		}
	}
	function Ce(e) { return Q.config.attributesToSettle.includes(e); }
	...
	function He(t, e) {
		...
		for (let e = 0; e < n.length; e++) {
			const r = n[e];
			try       { if (r.isInlineSwap(t)) { return true; } } 
			catch (e) { H(e); }
		}
		return t === "outerHTML";
	}
	function Te(e, o, i, t) {
		...
		if (r.length) {
			ie(r, function (e) {
				...
				if (r.shouldSwap) { qe(t); $e(s, e, e, t, i); Re(); }
				
				ie(i.elts, function (e) { ae(e, "htmx:oobAfterSwap", r); });
			});
	...
	function c(e, t, n, r) {
		...
		while (n.childNodes.length > 0) {
			...
			e.insertBefore(o, t);
			if (o.nodeType !== Node.TEXT_NODE && o.nodeType !== Node.COMMENT_NODE) { r.tasks.push(Le(o)); }
		}
	}
	function Ie(e, t) {
		let n = 0;
	...
	function De(t) {
		...
		for (let e = 0; e < t.attributes.length; e++) {
			...
			if (r.value) { n = Ie(r.name, n); n = Ie(r.value, n); }
		}
		return n;
	}
	function Pe(t) {
	...
	function ke(e) {
		...
		if (t.listenerInfos) { ie(t.listenerInfos, function (e) { if (e.on) { be(e.on, e.trigger, e.listener); } }); }
	...
	function S(e) {
		...
		ke(e);
		ie(e.children, function (e) { S(e); });
	}
	function Me(t, e, n) {
		if (t.tagName === "BODY") { return je(t, e, n); }
		...
		n.elts = n.elts.filter(function (e) { return e !== t; });
	...
	function Fe(e, t, n) { return c(e, e.firstChild, t, n); }
	function Be(e, t, n) { return c(u(e), e, t, n);         }
	function Xe(e, t, n) { return c(e, null, t, n);         }
	function Ue(e, t, n) { return c(u(e), e.nextSibling, t, n); }
	...
	function je(e, t, n) {
		...
		c(e, r, t, n);
		if (r) {
			while (r.nextSibling) { S(r.nextSibling); e.removeChild(r.nextSibling); }
			S(r);
			e.removeChild(r);
		}
	}
	function $e(t, e, n, r, o) {
		switch (t) {
			case "none":                     return;
			case "outerHTML":   Me(n, r, o); return;
			case "afterbegin":  Fe(n, r, o); return;
			case "beforebegin": Be(n, r, o); return;
			case "beforeend":   Xe(n, r, o); return;
			case "afterend":    Ue(n, r, o); return;
			case "delete":      Ve(n);       return;
			default:
				var i = Jn(e);
						...
						if (l) {
							if (Array.isArray(l)) {
								for (let e = 0; e < l.length; e++) {
									const c = l[e];
									if (c.nodeType !== Node.TEXT_NODE && c.nodeType !== Node.COMMENT_NODE) { o.tasks.push(Le(c)); }
								}
							}
							return;
						}
				...
				if (t === "innerHTML") { je(n, r, o); }
				else                   { $e(Q.config.defaultSwapStyle, e, n, r, o); }
		}
	}
	function _e(e, n, r) {
	...
	function ze(h, d, p, g) {
		...
		let e = function () {
			...
			const o = Sn(h);
			if (p.swapStyle === "textContent") { h.textContent = d; } 
			else {
				let n = D(d);
				...
				ie(x(n, "template"), function (e) {
					if (e.content && _e(e.content, o, r)) { e.remove(); }
				});
				if (g.select) {
					const u = te().createDocumentFragment();
					ie(n.querySelectorAll(g.select), function (e) { u.appendChild(e); });
					n = u;
				}
				qe(n);
			...
			if (t.elt && !se(t.elt) && ee(t.elt, "id")) {
				...
				if (f) {
					if (t.start && f.setSelectionRange) {
						try       { f.setSelectionRange(t.start, t.end); } 
						catch (e) {}
					}
					f.focus(a);
				}
			...
			if (!p.ignoreTitle) { Xn(o.title); }

			const n = function () {
				ie(o.tasks, function (e) { e.call(); });
			...
			if (p.settleDelay > 0) { b().setTimeout(n, p.settleDelay); } 
			else                   { n(); }
		};
		
		let t = Q.config.globalViewTransitions;
		
		if (p.hasOwnProperty("transition")) { t = p.transition; }
		...
		try {
			if (p?.swapDelay && p.swapDelay > 0) { b().setTimeout(e, p.swapDelay); } 
			else { e(); }
		...
		if (r.indexOf("{") === 0) {
			...
			for (const i in o) {
				if (o.hasOwnProperty(i)) {
					let e = o[i];
					if (k(e)) { n = e.target !== undefined ? e.target : n; } 
					else      { e = { value: e }; }
					ae(n, i, e);
				}
			}
			...
			const s = r.split(",");
			for (let e = 0; e < s.length; e++) { ae(n, s[e].trim(), []); }
		}
	}
	const Ke = /\s/;
	const E  = /[\s,]/;
	...
	function nt(r, o, i) {
		if (o[0] === "[") {
			...
			while (o.length > 0) {
				...
				if (tt(s, n, i)) { t += "((" + i + "." + s + ") ? (" + i + "." + s + ") : (window." + s + "))"; } 
				else             { t = t + s; }
				n = o.shift();
			}
		}
			...
			if (c !== "") {
				if (c === "every") {
					...
					while (o.length > 0 && o[0] !== ",") {
						const a = o.shift();
						if (a === "changed")        { f.changed = true;
						} else if (a === "once")    { f.once    = true;
						} else if (a === "consume") { f.consume = true;
						} else if (a === "delay" && o[0] === ":") {
							o.shift();
							f.delay = d(O(o, E));
						} else if (a === "from" && o[0] === ":") {
	...
	function lt(e) { oe(e).cancelled = true; }
	function ct(e, t, n) {
		const r = oe(e);
	...
	function ft(e) { return g(e, Q.config.disableSelector); }
		...
		ie(t, function (i) {
			const s = function (e) {
				...
				if (t.handledFor.indexOf(l) < 0) {
					...
					if (a.delayed)  { clearTimeout(a.delayed); }
					if (a.throttle) { return; }
	...
	function bt(e) {
		if (!s(e, "data-hx-revealed") && F(e)) {
			...
			const t = oe(e);
			if (t.initHash) { ae(e, "revealed"); }
			else            {
				e.addEventListener(
					"htmx:afterProcessNode",
					function () { ae(e, "revealed"); },
					{ once: true },
				);
			}
		}
